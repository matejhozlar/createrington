...
INSERT INTO vote (name, slug, description, status, game_version, mod_loader_type, class_id, base_modpack_project_id, max_mods_per_user, closes_at, discord_forum_channel_id, created_by) VALUES
  ('Createrington Season 3 Modpack', 'season-3-modpack',
   'Suggest and upvote mods for the season 3 modpack.',
   'open', '1.21.1', 6, 6, NULL, 5, NOW() + INTERVAL '14 days', '1483504809859481712', '818819241666281503');
