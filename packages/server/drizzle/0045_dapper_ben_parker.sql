...
CREATE UNIQUE INDEX "uq_player_prompt_response_prompt_discord_entry" ON "player_prompt_response" USING btree ("prompt_id","discord_id","entry_number");--> statement-breakpoint
CREATE INDEX "idx_player_prompt_response_prompt_discord" ON "player_prompt_response" USING btree ("prompt_id","discord_id");